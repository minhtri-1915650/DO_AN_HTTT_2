            ...
            <div class="wrapper overflow-hidden">
                                ...
                                <table class="table tinfo" style="width: 80%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Họ và tên" name="name" value="<?php if ($user) echo $user['fullname'] ?>" <?php if ($this->session->userdata('sessionKhachHang')) echo 'readonly' ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="<?php if ($this->session->userdata('sessionKhachHang')) echo 'tv';
                                                                                                else echo 'email' ?>" value="<?php if ($user) echo $user['email'] ?>" placeholder="Email" <?php if ($this->session->userdata('sessionKhachHang')) echo 'readonly' ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Số điện thoại" name="phone" value="<?php if ($user) echo $user['phone'] ?>" <?php if ($this->session->userdata('sessionKhachHang')) echo 'readonly' ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="DistrictId" id="district" class="form-control next-select">
                                                    ...
                                                    <?php $list = $this->Mdistrict->district_provinceid($id);
                                                    foreach ($list as $row) : ?>
                                                        <option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="address" placeholder="Địa chỉ giao hàng:" class="form-control" rows="4"="" style="height: auto !important;" value="<?php echo isset($user['address']) ?>"></textarea>
                ...
                <div>
                    ...
                    <div class="text-center">
                        <p style="font-weight:bold">Hoặc</p>
                    </div>
                    <form action="<?php echo $paypalUrl; ?>"  method="post" name="frmPayPal1" >
                        <div>
                            ...
                            <input type="hidden" name="amount" value="<?php echo round($money_pay/22000, 2) ?>">
